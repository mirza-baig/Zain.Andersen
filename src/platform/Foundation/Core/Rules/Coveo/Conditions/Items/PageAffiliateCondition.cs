...
{
    public class PageAffiliateCondition<T> : WhenCondition<T>, ICoveoCondition<T> where T : RuleContext
    {
        public string Value { get; set; }

        public IQueryNode GetQueryNode()
        {
            return new FieldNode(Constants.CoveoFields.AffiliateFieldName, QueryNodeOperator.Equal, Constants.Token.PageAffiliateId);
        }
