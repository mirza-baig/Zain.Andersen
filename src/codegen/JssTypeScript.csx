...
public string RenderImportStatements()
{
    ...
    localCode.AppendLine($@"// @ts-ignore Prevent noUnusedLocals from triggering an error, we import all core field types to minimize changing to code generation.");
    localCode.AppendLine($@"import {{ ComponentRendering, RouteData, Field, ImageField, Item, FileField, LinkField }} from '@sitecore-jss/sitecore-jss-nextjs';");
    localCode.AppendLine($@"// @ts-ignore Prevent noUnusedLocals from triggering an error, we import all core field types to minimize changing to code generation.");
    localCode.AppendLine($@"import {{ ComponentProps }} from '@/lib/types/component-props';");
