...
const pluginDefinitions = [
  ...
  {
    listPath: 'src/temp/sourcing-cookies-plugins.ts',
    rootPath: 'src/lib/sourcing-cookies/plugins',
    moduleType: ModuleType.ESM,
  },
  {
    listPath: 'src/temp/personaliztion-parameters-plugins.ts',
    rootPath: 'src/lib/personalization/parameters/plugins',
    moduleType: ModuleType.ESM,
  },
];
