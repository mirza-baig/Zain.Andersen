  ...
  return {
    aw: {
      classes: {
        ...
        radioListItem: ` radio__list-item flex flex-[0_0_100%] max-w-full md:flex-[0_0_50%] md:max-w-[50%] `,
        ...
        radioUnselected: ` unselected bg-[rgba(228,229,228,1)] [&_small]:translate-x-[110%] [&_small]:bg-[#b2b3b0] `,
        radioSelected: ` selected bg-[#f7ccbf] [&_small]:translate-x-[10%] [&_small]:bg-[#ef6134] `,
