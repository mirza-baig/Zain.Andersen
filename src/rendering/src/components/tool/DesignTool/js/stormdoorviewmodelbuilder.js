...
export class StormdoorViewModelBuilder extends ViewModelBuilderBase {
  ...
  _buildSizingAttribute(renoworksResult, attributes) {
    var tab = singleOrDefault(renoworksResult.exteriorResult.product.tab, _ => _.name === RenoworksKeys.Width.name);
    ...
    tab = singleOrDefault(renoworksResult.exteriorResult.product.tab, _ => _.name === RenoworksKeys.Height.name);
  ...
  _buildOperationAttribute(renoworksResult, imageHelpers, attributes) {
    var tab = singleOrDefault(renoworksResult.exteriorResult.product.tab, _ => _.name === RenoworksKeys.Operation.name);
    if (tab != null)
    {
  ...
  _buildHardwareOptionsAttribute(renoworksResult, imageHelpers, attributes) {
    var tab = singleOrDefault(renoworksResult.exteriorResult.product.tab, _ => _.name === RenoworksKeys.HardwareOptions.name);
  ...
  _buildGlassAttribute(renoworksResult, imageHelpers, attributes) {
    var tab = singleOrDefault(renoworksResult.exteriorResult.product.tab, _ => _.name === RenoworksKeys.Glass.name);
    if (tab != null)
    {
      var vm = new SwatchAttributeViewModel();
  ...
  _buildGrilleStyleAttribute(renoworksResult, imageHelpers, attributes) {
    var tab = singleOrDefault(renoworksResult.exteriorResult.product.tab, _ => _.name === RenoworksKeys.GrilleStyle.name);
