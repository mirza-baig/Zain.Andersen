...
export class AWViewModelBuilder extends ViewModelBuilderBase {
  ...
  beforeRenoworksCall(productSettingValues) {
    if (this._sizingIsEnabled)
    {
      ...
      if (EntryDoorProducts.indexOf(this.product.renoworksKey) >= 0)
      {
        ...
        {
          this._currentProductConfiguration = singleOrDefault(this.product.configuration, configuration => configuration.renoworksName === productSettingValues.get(this._Configuration));
      ...
      if (this._currentProductConfiguration)
      {
        ...
        {
          currentDimensionMapping = singleOrDefault(dimensionMappings, _ => _.width === productSettingValues.get(this._WidthInches) && _.height === productSettingValues.get(this._HeightInches))
            || firstOrDefault(dimensionMappings, _ => _.width === productSettingValues.get(this._WidthInches))
            || first(dimensionMappings);
        }
        else if (productSettingValues.has(this._WidthInches))
        {
          currentDimensionMapping = firstOrDefault(dimensionMappings, _ => _.width === productSettingValues.get(this._WidthInches))
            || first(dimensionMappings);
        }
        else
        {
  ...
  _buildConfigurationAttribute(renoworksResult, imageHelpers, attributes) {
    if (EntryDoorProducts.indexOf(this.product.renoworksKey) >= 0)
    {
      ...
      if (tab != null)
      {
        var vm = new SwatchAttributeViewModel();
  ...
  _buildSideliteStyleAttribute(renoworksResult, imageHelpers, attributes) {
    var tab = singleOrDefault(renoworksResult.exteriorResult.product.tab, _ => _.name === RenoworksKeys.SideliteStyle.name);
    if (tab != null)
    {
      var vm = new SwatchAttributeViewModel();
  ...
  _buildSizingAttribute(renoworksResult, attributes) {
    ...
    {
      var vm = new SizingAttributeViewModel(this.product.text.sizing, this.product.text.customSizing);
  ...
  _buildPanelStyleAttribute(renoworksResult, imageHelpers, attributes) {
    var tab = singleOrDefault(renoworksResult.exteriorResult.product.tab, _ => _.name === RenoworksKeys.PanelStyle.name);
    if (tab != null)
    {
      var vm = new SwatchAttributeViewModel();
  ...
  _buildBottomRailHeightAttribute(renoworksResult, imageHelpers, attributes) {
    ...
    var tab = singleOrDefault(renoworksResult.exteriorResult.product.tab, _ => _.name === RenoworksKeys.BottomRailHeight.name);
    if (tab != null)
    {
      ...
      var vm = new TextAttributeViewModel();
  ...
  _buildRailAndStileWidthAttribute(renoworksResult, imageHelpers, attributes) {
    ...
    var tab = singleOrDefault(renoworksResult.exteriorResult.product.tab, _ => _.name === RenoworksKeys.RailAndStileWidth.name);
    if (tab != null)
    {
      // Renoworks is sending us data, so check the panel style to see if we should actually add it
      var panelStyle = renoworksResult.productSettingValues.get(this._PanelStyle);
  ...
  _buildInteriorFrameColorAttribute(renoworksResult, imageHelpers, attributes) {
    var tab = singleOrDefault(renoworksResult.interiorResult.product.tab, _ => _.name === RenoworksKeys.FrameColor.name);
    if (tab != null)
    {
      var showMahoganyNote = false;

      var vm = new TabbedSwatchAttributeViewModel();
  ...
  _buildFrameStainAttribute(renoworksResult, imageHelpers, attributes) {
    var tab = singleOrDefault(renoworksResult.interiorResult.product.tab, _ => _.name === RenoworksKeys.FrameStain.name);
    if (tab != null)
    {
      var vm = new TabbedSwatchAttributeViewModel();
  ...
  _buildInteriorStainPaintAttribute(renoworksResult, imageHelpers, attributes) {
    var tab = singleOrDefault(renoworksResult.interiorResult.product.tab, _ => _.name === RenoworksKeys.InteriorStainPaint.name);
    if (tab != null)
    {
      var vm = new TabbedSwatchAttributeViewModel();
  ...
  _buildHardwareAttribute(renoworksResult, imageHelpers, attributes) {
    var vm = new HardwareAttributeViewModel();
    ...
    var tab = singleOrDefault(renoworksResult.interiorResult.product.tab, _ => _.name === RenoworksKeys.HardwareOptions.name);
    if (tab != null)
    {
      for (let component of tab.component)
      {
        ...
        if (component.color)
        {
          var optionalHardwareTab = singleOrDefault(renoworksResult.interiorResult.product.tab, _ => _.name === RenoworksKeys.OptionalHardware.name);
          var optionalHardware = optionalHardwareTab === null ? null : singleOrDefault(optionalHardwareTab.component, _ => _.selected);
    ...
    tab = singleOrDefault(renoworksResult.interiorResult.product.tab, _ => _.name === RenoworksKeys.OptionalHardware.name);
  ...
  _buildBlindsBetweenGlassAttribute(renoworksResult, imageHelpers, attributes) {
    var tab = singleOrDefault(renoworksResult.interiorResult.product.tab, _ => _.name === RenoworksKeys.BlindsBetweenGlass.name);
    if (tab != null)
    {
      var vm = new SwatchAttributeViewModel();
  ...
  _buildGrilleTypeAttribute(renoworksResult, imageHelpers, attributes) {
    var tab = singleOrDefault(renoworksResult.interiorResult.product.tab, _ => _.name === RenoworksKeys.GrilleType.name);
    if (tab != null)
    {
      var vm = new SwatchAttributeViewModel();
  ...
  _buildGrillePatternAttribute(renoworksResult, imageHelpers, attributes) {
    var tab = singleOrDefault(renoworksResult.interiorResult.product.tab, _ => _.name === RenoworksKeys.GrilleStyle.name);
    if (tab != null)
    {
      var vm = new SwatchAttributeViewModel();
  ...
  _buildGrilleWidthAttribute(renoworksResult, imageHelpers, attributes) {
    var grilleStyle = singleOrDefault(renoworksResult.interiorResult.product.tab, _ => _.name === RenoworksKeys.GrilleStyle.name);
    if (grilleStyle === null)
    {
      return;
    }
    ...
    var selectedGrilleStyle = singleOrDefault(grilleStyle.component, _ => _.selected);
  ...
  _buildExteriorFrameColorAttribute(renoworksResult, imageHelpers, attributes) {
    var tab = singleOrDefault(renoworksResult.exteriorResult.product.tab, _ => _.name === RenoworksKeys.FrameColor.name);
    var sashColorTab = singleOrDefault(renoworksResult.exteriorResult.product.tab, _ => _.name === RenoworksKeys.SashColor.name);
  ...
  _buildExteriorTrimProfileAttribute(renoworksResult, imageHelpers, attributes, progressBarIndex) {
    var tab = singleOrDefault(renoworksResult.exteriorResult.product.tab, _ => _.name === RenoworksKeys.ExteriorTrimProfile.name);
    if (tab != null)
    {
      var vm = new SwatchAttributeViewModel(progressBarIndex);
  ...
  _buildProfileStyleAttribute(renoworksResult, imageHelpers, attributes, progressBarIndex) {
    var tab = singleOrDefault(renoworksResult.interiorResult.product.tab, _ => _.name === RenoworksKeys.ProfileStyle.name);
  ...
  _buildExteriorTrimColorAttribute(renoworksResult, imageHelpers, attributes) {
    var exteriorTrimProfile = singleOrDefault(renoworksResult.exteriorResult.product.tab, _ => _.name === RenoworksKeys.ExteriorTrimProfile.name);
    if (exteriorTrimProfile === null)
    {
      return;
    }

    var selectedExteriorTrimProfile = singleOrDefault(exteriorTrimProfile.component, _ => _.selected);
    ...
    if (selectedExteriorTrimProfile.color && selectedExteriorTrimProfile.color.length > 0 && selectedExteriorTrimProfile.name != "None")
    {
      ...
      var vm = new DependentSwatchAttributeViewModel(selectedControlOption);
  ...
  _buildGlassAttribute(renoworksResult, imageHelpers, attributes) {
    ...
    var tab = singleOrDefault(renoworksResult.interiorResult.product.tab, _ => _.name === RenoworksKeys.GlassOptions.name);
    if (tab != null)
    {
      var vm = new RadioAttributeViewModel();
  ...
  _buildOperationAttribute(renoworksResult, imageHelpers, attributes) {
    var tab = singleOrDefault(renoworksResult.interiorResult.product.tab, _ => _.name === RenoworksKeys.Operation.name);
    if (tab != null)
    {
      var vm = new SwatchAttributeViewModel();
  ...
  _buildShapeAttribute(renoworksResult, imageHelpers, attributes) {
    var tab = singleOrDefault(renoworksResult.interiorResult.product.tab, _ => _.name === RenoworksKeys.Shape.name);
    if (tab != null)
    {
      var vm = new SwatchAttributeViewModel();
