...
import { getCheckboxTheme } from '../../../helpers/Forms/Fields/Checkbox.Theme';

export const RbAConsultRequestCanadaTheme = (hasSidebar: boolean): ThemeFile => {
  return {
    aw: {
      classes: {
        ...
        disclaimer: 'pt-5 text-legal text-dark-gray  font-light leading-[15px]',
        sidebar: classNames(
          hasSidebar
