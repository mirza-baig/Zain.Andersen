...
import { RbAConsultRequestCanadaTheme } from './RbAConsultRequestCanada.theme';
...
export type RbAConsultRequestCanadaProps =
  Feature.EnterpriseWeb.AndersenWindows.Components.General.RbAConsultRequestCanada.RbAConsultRequestCanada;
...
const RbAConsultRequestCanada = (props: RbAConsultRequestCanadaProps) => {
  const hasSidebar =
    props.fields?.sidebarContentHeading.value !== '' || props.fields?.sidebarBodyCopy.value !== '';
  const hasCanadaDisclaimer = props.fields?.canadaDisclaimerText.value !== '';

  const { themeData } = useTheme(RbAConsultRequestCanadaTheme(hasSidebar));
  ...
  const fetcher = async (url: string) => {
    ...
    if (queryStringStoreId) {
      ...
      const mainSection = document.querySelectorAll(
        '#main > section:not([data-component="RbAConsultRequestCanada"])'
      );
  ...
  useEffect(() => {
    ...
    if (dataFetchComplete) {
      ...
      const sidebarSection = document.querySelectorAll('#RbAConsultRequestCanadaSideBar');
  ...
  return (
    <Component variant="lg" dataComponent="RbAConsultRequestCanada" {...props}>
      <div className="col-span-12">
        ...
        {!displayErrorMsg && (
          <div className={themeData.classes.contentContainer}>
                              ...
                              <div className="relative">
                                <label htmlFor="canadaDisclaimer" className="inline-flex">
                                  <Field
                                    ...
                                    className={classNames(
                                      'input customTickIcon invalidInput peer h-[20px] w-[20px] cursor-pointer appearance-none border-[1px] border-dark-gray checked:!bg-black hover:border-black focus:bg-gray focus:!ring-0',
                                  ...
                                  />
                                  <RichTextWrapper
                                    field={{ value: props.fields?.canadaDisclaimerText.value }}
                                    classes={
            ...
            {hasSidebar && (
              <div id="RbAConsultRequestCanadaSideBar" className={themeData.classes.sidebar}>
...
export default withDatasourceCheck()<RbAConsultRequestCanadaProps>(RbAConsultRequestCanada);
